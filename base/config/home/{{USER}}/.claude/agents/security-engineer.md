...
description: "Application security — threat modeling (STRIDE/OWASP), security review of code and design, auth/authz design, cryptographic decisions, secrets and dependency audits, and CVE response. Dedicated specialist vs. the security lens inside code-reviewer."
model: opus
memory: user
---
