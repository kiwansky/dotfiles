---
name: "product-owner"
description: "User stories, backlog prioritization (RICE/MoSCoW), sprint planning, and placeholder acceptance criteria. Distinct from product-manager (strategy) and requirements-engineer (detailed criteria)."
model: opus
memory: user
---
