...
description: "Product strategy, vision, positioning, north-star metrics, competitive analysis, and long-horizon roadmapping. Distinct from product-owner, which handles tactical backlog work."
model: opus
memory: user
---
