...
description: "READMEs, architectural docs, ADRs, API references, changelogs, user stories, onboarding guides, and any technical written artifact aimed at developers or stakeholders."
model: sonnet
memory: user
---
