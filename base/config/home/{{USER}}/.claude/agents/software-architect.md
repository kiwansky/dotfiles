...
description: "Architectural design, ADRs, system-level technical direction, and refactoring strategy. Favors the simplest viable design that does not block forward progress."
model: opus
memory: user
---
